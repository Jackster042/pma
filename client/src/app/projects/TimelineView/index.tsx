    ...
    <div className="px-4 xl:px-6">
      <div className="flex flex-wrap items-center justify-between gap-2 py-5">
        ...
        <div className="relative inline-block w-64">
          <select
            className="focus:shadow-outline dark:border-dark-secondary dark:bg-dark-secondary block w-full appearance-none border border-gray-400 bg-white px-4 py-2 pr-8 leading-tight shadow focus:outline-none dark:text-white"
