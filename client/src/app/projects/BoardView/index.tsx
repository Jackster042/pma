      ...
      <div className="mb-3 flex w-full">
        ...
        <div className="dark:bg-dark-secondary flex w-full items-center justify-between rounded-e-lg bg-white px-5 py-4">
          ...
          <div className="flex items-center gap-1">
            ...
            <button
              className="dark:bg-dark-tertiary flex h-6 w-6 cursor-pointer items-center justify-center rounded bg-gray-200 dark:text-white"
          ...
          <div className="flex flex-1 flex-wrap items-center gap-2">
            ...
            <div className="flex gap-2">
              {taskTagsSplit.map((tag) => (
                <div key={tag} className="bg-b;ue-100 rounded-full px-2 py-1">
                  {tag}
                </div>
              ))}
            </div>
